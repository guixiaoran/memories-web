...
export const MemoryWalkDetailed = (props) => {
  useEffect(() => {
    Animator.init();
    let plyrWidth = document.getElementsByClassName('plyr')[0].style.width;
    document.getElementsByClassName('plyr')[0].style.width = '100%';
    document.getElementsByClassName('plyr')[1].style.width = '100%';
    return () => {
      Animator.destroy();
      document.getElementsByClassName('plyr')[0].style.width = plyrWidth;
      document.getElementsByClassName('plyr')[1].style.width = plyrWidth;
    };
  }, [props]);
      ...
      <div className="memory-container">
        <div className="memory-img" style={{
          ...
          <TrackVisibility partialVisibility style={{
            ...
            {
              ({ isVisible }) => <VideoPlayer isVisible={isVisible} id="video1" url={props.location.params.memory.url} />
            }
          </TrackVisibility>
        </div>
      ...
      <div className="memory-container">
        <div className="memory-img" style={{
          ...
          <TrackVisibility partialVisibility style={{
            ...
            {
              ({ isVisible }) => <VideoPlayer isVisible={isVisible} id="video2" url={props.location.params.memory.secondUrl} />
            }
          </TrackVisibility>
        </div>

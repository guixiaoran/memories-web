...
import { Documentary, Home, FourOFour, VideoStories, Archive, MemoryWalks, MemoryWalkDetailed, Navigator, Plaza, Team, ProjectStory } from 'views';
...
export const AppRoutes = (props) => {
  ...
  return (
    <Switch>
      ...
      <Route exact path='/story' render={() => <Layout><ProjectStory {...props} /></Layout>} />
